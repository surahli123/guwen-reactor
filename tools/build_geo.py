...
PTS_LL = {
    ...
    # ---- tier-2(2026-07-02):凡例同上,未载事发地者依籍贯/郡望/都城作接受史锚点 ----
    "G04": (113.85, 34.02),  # 潁川許縣(陳寔;陳太丘與友期行)
    "G05": (112.45, 34.62),  # 洛陽(孔文舉隨父到洛;小時了了)
    "G06": (115.78, 33.85),  # 譙(魏武籍贯;望梅止渴,行軍道中未載)
    "G07": (112.45, 34.62),  # 洛陽(魏都;七步詩,事發地未明言)
    "G08": (116.20, 36.85),  # 平原高唐(華歆籍贯;急不相棄,乘船途中未載)
    "G09": (113.47, 34.15),  # 潁川陽翟(荀氏郡望;荀巨伯,郡名未載)
    "G10": (118.78, 32.04),  # 建康(晉元帝朝;舉目見日,與 G02 同城)
}
PTS = {}
